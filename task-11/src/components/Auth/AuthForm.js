...
const AuthForm = () => {
  ...
  const submitHandler = (event) => {
    ...
    if (isLogin) {
      URL =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB7SUz01BUzsKEBIUEZ0cD-RhgyjII9cBE";
    } else if (isFormValid) {
      URL =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB7SUz01BUzsKEBIUEZ0cD-RhgyjII9cBE";
    }
    fetch(URL, {
      method: "POST",
      body: JSON.stringify({
