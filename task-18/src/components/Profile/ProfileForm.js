...
const ProfileForm = () => {
  ...
  useEffect(() => {
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyB7SUz01BUzsKEBIUEZ0cD-RhgyjII9cBE",
      {
        method: "POST",
        headers: {
  ...
  const updateProfile = (event) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyB7SUz01BUzsKEBIUEZ0cD-RhgyjII9cBE",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
